          ...
          <div class="row justify-content-evenly">
               ...
               <div class="col-6">
                    <form action="Rydho_mybooking.php" method="POST">
                         <div>
                              <div class="mb-3">
                                   <label for="name" class="form-label">NAME_NIM</label>
                              ...
                              <div class="mb-3">
                                   ...
                                   <input type="Book_date" class="form-control" name="Book_date" id="exampleFormControlInput1">
                              </div>
                              <div class="mb-3">
                              ...
                              <div class="mb-3">
                                   <label for="exampleFormControlInput1" class="form-label">durations (Days)</label>
                                   <input type="number" class="form-control" name="durations" id="exampleFormControlInput1">
                              </div>
                              <div>
                                   <label for="">Pilih Mobil yang di RENTAL</label>
                                   <select class="form-select" name="Cartype" style="margin-bottom: 16px;" aria-label="Default select example">
                                        <?php
